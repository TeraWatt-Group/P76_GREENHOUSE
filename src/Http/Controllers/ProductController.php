...
class ProductController extends Controller
{
    public function index(Request $request)
    {
        return view('green.product.index')
            ->withProduct(Category::select(\DB::raw('category_description.name as category, products.productid as productid, product_description.name as name, products.image as image'))
                                ...
                                ->leftJoin('products', 'products.productid', 'product_to_category.productid')
